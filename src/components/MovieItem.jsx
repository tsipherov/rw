          ...
          <div className="card-body">
            ...
            <div className="d-flex justify-content-between">
              ...
              { this.props.handlerWillWatch? 
                ...
                className={`btn ${this.state.willWatch? 'btn-warning' : 'btn-info'} btn-sm btn-watch`}
                >
            ...
            {this.props.handle ? (
              ...
              <button
                ...
                className={this.state.like ? "btn btn-primary btn-sm" : "btn btn-secondary btn-sm"}
              >
                Like
          </button>
              <button
                type="button"
                onClick={() => { this.props.handle(this.state.movie.id) }}
